...
Notre méthode de traitement des homographies repose sur l'interprétation d'une homographie en terme de mouvement de caméra. La partie ci-dessous présente cette interprétation.
...
On étudie ici un cas à priori particulier d'homographie $h$   que l'on peut interpréter comme un mouvement de caméra (on montrera par la suite que c'est en fait un cas général).\\
\begin{figure}[h!]
\centering
