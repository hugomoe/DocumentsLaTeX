...
--> j'ai [shmuel] relu l'anglais mais pas le contenu mathématique. Y'a une correction dont je ne suis pas sûr : il y avait "values for integers are precomputed", j'ai mis "integer values" mais peut-être que ça voulait dire "values on integers" ?
