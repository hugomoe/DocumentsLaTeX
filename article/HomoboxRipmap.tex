...
\subfigure[identité]{
\includegraphics[scale =0.30]{f14.png}}
...
\end{proof}
Dans nos algorithmes  on utilisera généralement cette propriété pour $n=3$ mais on calculera l'opérateur $D_d^n$ en faisant des différences successive %ref pseudo code 
...
\end{itemize}
Ces formules sont utilisées dans le pseudo code %ref pseudo code eval 4 int 
...
\end{eqnarray*}
Ces formules sont utilisées dans le pseudo code.\\ %ref pseudo build 4 int %\\
