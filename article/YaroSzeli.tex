...
%A voir peut être dans les expériences ?
	Dans les deux paragraphes suivants, l'erreur \emph{RMS} corresponds à la norme L2 de la différence entre l'image initiale et l'image ayant subie une rotation, l'erreur L1 est la norme L1 de cette même différence, et l'erreur max est la norme sup de cette différence.\\
...
Pour les expériences qui suivent, la méthode de traitement des affinités multi-étapes, avec le \emph{raised cosine-weighted sinc} comme filtre d'interpolation a été choisie (pusiqu'elle est toujours dans les méthodes les plus rapides quelque soit la taille de l'image, et parce qu'elle donne des résultats excellents pour deux rotations).  
 ...
 \subfigure[Erreurs des 360 rotations de 1 degré]{\begin{tabular}{|c|c|c|c|c|}
  ...
  affinité multi-étape, b-spline d'ordre 9 & 6.84302 &  4.03709 & 86.8555 &  6114.14\\
  affinité multi-étape, b-spline d'ordre 3 & 14.8694 & 8.52079 & 158.043 & 1268.18\\
  Yaroslavsky & 14.1871 & 7.77912 & 211.169 & 1839.852385 \\
  affinité multi-étapes, \emph{raised cosine-weighted sinc} &  828.852 & 503.147 & 13638.2 & 778.429\\
  \hline
\end{tabular}} 
...
\label{troiscentrotations}
 ...
 \subfigure[Erreurs des 10 rotations de $\frac{\pi}{5}$ radians.]{\begin{tabular}{|c|c|c|c|c|}
  ...
  affinité multi-étapes, \emph{raised cosine-weighted sinc} &   5.979119 & 3.624343 & 72.128845 \\
  \hline
 \end{tabular}}
