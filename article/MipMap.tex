...
Rq : On a une interprétation géométrique comme un mouvement de caméra de ces valeurs.

\sssse{Conclusion}

Les méthode du déterminant, du plus grand côté du parallélogramme et du maximum des valeurs singulières sont satisfaisantes.
...
Pour tenter de pallier ce problème on utilise un Ripmap \cite{akenine2008real}. C'est en fait un Mipmap où l'on a aussi calculé la moyenne des pixels de tous les rectangles dont les côtés sont des puissances de deux.
