...
Un exemple est représenté figure \ref{MipMap_real}. Un pseudo-code naif qui effectue cette construction figure en annexe en \ref{pseudo_code_Mipmap}, c'est l'algorithme \ref{buildMipmap}.
