...
HOMOGRAPHIE
	...
	c’est un mvt d’une caméra idéale (citer david lowe pour stitching)
...
AFFINITE
	Theoreme 1 mis avec les schémas, après l'explication de la méthode %shmuel
	formule convolution discrète avec zoom (reference pseudo-code supp adaptatif) %shmuel
	...
	prop 1 : Soit A affine sous forme projective %shmuel
	barre dans les matrice d'homographie : homogénéisé -> retirer les barres %shmuel
