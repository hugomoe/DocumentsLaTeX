...
\subsubsection{Étapes de l'algorithme}
	...
	\paragraph{Éventuelle transposition}
		...
		Les $\mathcal R$ peuvent, si l'affinité est par exemple une rotation d'angle $\frac{\pi}{2}$, compresser l'image sur peu de pixels puis tenter de la dilater ; cet effet est un \emph{bottleneck problem} (faut-il le traduire \red{problème d'embouteillage} ?) déjà connu \cite{wolberg1990digital}.
