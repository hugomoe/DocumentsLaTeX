...
One can notice that the decompostion reduces aliasing on some homographies (homographies 1, 4 and 5). For a diagonal transforms it reduces the blur (homographie 2). There exists however   
