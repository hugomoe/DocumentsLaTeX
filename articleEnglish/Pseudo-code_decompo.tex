...
% On prend donc $t_0 = x_2 = -\frac{\Delta_H(0,0)}{(r^2+s^2)\hat s}, t_1 = y_2 = 0$ ou $t_0 = x_2 = 0, t_1 = y_2 = -\frac{\Delta_H(0,0)}{(r^2+s^2)\hat r}$, en choisissant de sorte à ne pas diviser par zéro.
   ...
   \begin{algorithme}
     ...
     \eIf{$as-br\neq0$}{
      $t_0 = -\frac{\Delta_H(0,0)}{(r^2+s^2)\hat s}$\tcc*{see \eqref{equationAlgo6}}
      $t_1 = 0$\;
     }{
      $t_0 = 0$\;
      $t_1 = -\frac{\Delta_H(0,0)}{(r^2+s^2)\hat r}$\tcc*{see \eqref{equationAlgo6}}
     }
     $N_\phi = \sqrt{r^2+s^2}$\;
     $R_\phi = \pmatrice{
 ...
 ($\Delta_H$ is defined in formula \ref{equationAlgo6}).
