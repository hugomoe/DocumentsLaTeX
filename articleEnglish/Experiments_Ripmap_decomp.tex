...
\caption{Homography 1 : The geometric decompostion method creates less aliasing}
\label{Homo1}
\end{figure}
...
\caption{Homography 2 : The geometric decompostion method does not over-blur (see part \ref{Ripmap})}
\label{Homo2}
\end{figure}
...
\caption{Homography 4 : The geometric decompostion method creates less aliasing}
\label{Homo4}
\end{figure}
...
\caption{Homography 5 : The geometric decompostion method creates less aliasing. See the detail on figure \ref{Homo5det}}
\label{Homo5}
\end{figure}
