...
$$D(x,y) = \sqrt{ |\frac{\dr u}{\dr x}\frac{\dr v}{\dr y}-\frac{\dr u}{\dr y}\frac{\dr v}{\dr x}| }$$
Cette formule est justifiée car le déterminant est l'aire du parallélogramme, donc un carré de côté $D(x,y)$ est de même aire que le parallélogramme qu'il approche.
