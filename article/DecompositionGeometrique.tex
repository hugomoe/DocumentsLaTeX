...
Dans la suite de cette section on fixe un jeu de paramètres $(\theta,\phi,\psi,\delta,\delta',\cbf,Z)$ et on considère le mouvement de caméra $H$ associé à ces paramètres.
