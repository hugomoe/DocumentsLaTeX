...
%\label{pleinsderotations}
 ...
 \centering
   ...
   \subfigPDP{lena.png after 360 rotations by multi-pass resampling method (interpolation filter : raised cosine-weighted sinc)}{raised-cosine_beta0-36_lena.png}
   \subfigPDP{lena.png after 360 rotations by multi-pass resampling method (interpolation by B-Spline of order 3)}{b-spline_order3_lena.png}
   \subfigPDP{lena.png after 360 rotations by multi-pass resampling method (interpolation by B-Spline of order 9)}{b-spline_order9_double_lena.png}
 ...
 \subfigure[Errors on the 360 rotations of 1 degree]{\begin{tabular}{|c|c|c|c|c|}
  ...
  \hline
\end{tabular}} 
\caption{360 rotations of 1 degree (cf. section \ref{pleinsderotations})}
...
%On pourrait remplacer l'interpolation par convolution par une b-spline si on accordait moins d'importance au temps de calcul et si on avait une assurance que les rotations seront faibles (par exemple, si les homographies sont déjà presque unidirectionnelles), .
 ...
 \begin{figure}[h]
   ...
   \subfigPDP{lena.png after 10 rotations by multi-pass resampling method (interpolation filter : raised cosine-weighted sinc)}{lena_10_rotations_szeli.png}
   \subfigPDP{lena.png after 10 rotations by Yaroslasky's method}{lena_10_rotations_yaro.png}
   \subfigPDP{difference between lena.png and lena.png after dix rotations rotations by multi-pass resampling method (interpolation filter : raised cosine-weighted sinc)}{raised-cosine_beta0_36_10rot_lena_error.png}
   \subfigPDP{différence entre lena.png et lena.png after 10 rotations by Yaroslasky's method}{lena_10_rotations_yaro_error.png}
 \subfigure[Errors on 10 rotations of 36 degrees]{\begin{tabular}{|c|c|c|c|c|}
  \hline
  Méthode & RMSE  & MAE & maximal error  \\
  \hline
  ...
  \hline
 \end{tabular}}
 \caption{Effect of 10 rotations (cf. section \ref{pleinsderotations})}
 \label{rotalena}
 \end{figure}
