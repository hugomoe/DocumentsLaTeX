...
\caption{Illustration d'un mouvement de caméra $(X_v =0)$ (les translations ont été omise pour plus de clarté. $F$ représente le point focal de la caméra, le plan rouge est le plan image de la caméra.}
\label{shmdecomp}
\end{figure}
\begin{Def}
