The new method for homographiy resampling is based on the decomposition of an homography which can be seen as camera movement. The section below presents that decompostion.
