...
Voici un exemple naïf de construction d'un mipmap. On fait simplement la moyenne des quatre pixels concernés.
 ...
 \medbreak
  \medbreak
 Ce n'est pas une bonne méthode, en pratique on a fait précéder chaque moyennage par un filtrage gaussien de l'image. C'est une phase de précalcul, on tolère le fait qu'elle soit relativement coûteuse.  
