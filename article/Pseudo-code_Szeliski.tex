\subsection{Pseudo-code pour la méthode multi-étape de traitement des affinités}
 ...
 \subsubsection{Traitement des affinités multi-étape}
  ...
  \subsubsection{Traitement des affinités multi-étape, adapté pour les homographies}
