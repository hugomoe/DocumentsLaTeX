...
\begin{figure}
\subfigure[Geometric-based decomposition]{\includegraphics[scale=0.4]{img_f_1.png}}
...
\begin{figure}
\subfigure[Geometric-based decomposition]{\includegraphics[scale=0.4]{img_f_2.png}}
...
\begin{figure}
\subfigure[Geometric-based decomposition]{\includegraphics[scale=0.4]{img_f_3.png}}
...
\begin{figure}
\subfigure[Geometric-based decomposition]{\includegraphics[scale=0.4]{img_f_4.png}}
...
\begin{figure}
\subfigure[Geometric-based decomposition]{\includegraphics[scale=0.4]{img_geo_5.png}}
