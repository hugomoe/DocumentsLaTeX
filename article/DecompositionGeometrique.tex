...
R_{\psi}^{-1} \cdot H_t \cdot R_{\phi}^{-1} \sim 
 ...
 |R x_2 +S y_2 +T|\frac{\Delta_H(x_2 , y_2)}{\sqrt{r^2 + s^2}\sqrt{R^2 + S^2}}&-|R x_2 +S y_2 +T|\sqrt{\frac{R^2 + S^2}{r^2 + s^2}}&0\\
 -|R x_2 +S y_2 +T|\sqrt{r^2 + s^2}&0&1
 \end{pmatrix}
\end{equation*}
Où l'on a posé 
\begin{equation*}
\Delta_H(x_2 , y_2 ) =R ((rc+sd)-(r^2 + s^2)y_2) - S ((ar+sb)-(r^2 + s^2 )x_2)
\end{equation*}
Les solutions de $\Delta_H(x_2 , y_2 )=0$ sont
\[\left\lbrace \left(x_2=\frac{ar+sb+R \lambda}{r^2 +s^2}, y_2=\frac{cr+sd+S \lambda}{r^2 +s^2}\right), \lambda \in \mathbb R\right\rbrace\]
On a dans ce cas
\begin{equation*}
...
0&-1&0\\
 ...
 \begin{equation*}
  \lambda^2 + \lambda^2 \delta'^2 \frac{(R^2 + S^2)^2}{r^2 + s^2}=1
 \end{equation*}
 C'est-à-dire
 \begin{equation*}
  \delta'^2 = (r^2 + s^2) \frac{1-\lambda^2}{\lambda^2 (R^2+S^2)^2}
 \end{equation*}
